    ...
    <form action="{{ action('CompanyController@store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="collapse show" id="options">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="companyCountry" id="companyCountry"
                                    style="width: 100%">
                ...
                {{-- products --}}
                <div class="card shadow mb-4">
                    <a href="#companyProducts" class="d-block card-header py-3" data-toggle="collapse" role="button"
                        aria-expanded="true" aria-controls="companyProducts">
                    ...
                    <div class="collapse show" id="companyProducts">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="custom-select" multiple="multiple" id="companyProductsSelect"
                                    name="companyProducts[]" style="width: 100%">
...
<script>
    ...
    $('#companyProductsSelect').select2();
});

$(document).ready(function() {
    $('#companyServicesSelect').select2();
});
</script>
@endsection
