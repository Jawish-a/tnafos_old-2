<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand" href="/"> <svg id="ae9a0706-d2c6-4063-905e-123e81e16a38" style="max-width:50px;"
                data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 139.04 153.63">
                <defs>
                    <style>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('list')}}">List <span class="badge">{{ Session::has('Quest') ? Session::get('Quest')->totalQty : ''}}</span></a>
                </li>
                <li class="nav-item">
