    ...
    <li class="nav-item">
        ...
        <div id="categories" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('category')}}">List of Categories</a>
                <a class="collapse-item" href="{{url('category/create')}}">Create a Category</a>
            </div>
        </div>
    </li>
    {{-- uncomment this when products is ready --}}
{{--     <li class="nav-item">
        ...
        <div id="brands" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('brand')}}">List of Brands</a>
                <a class="collapse-item" href="{{url('brand/create')}}">Create a Brand</a>
            </div>
        </div>
    </li> --}}
    {{-- uncomment this when the product order is ready --}}
    {{--   <li class="nav-item">
    ...
    <div id="products" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{url('/product')}}">List of Products</a>
    <a class="collapse-item" href="{{url('/product/create')}}">Create a Product</a>
    </div>
    </div>
    </li> --}}
    <li class="nav-item">
        ...
        <div id="services" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{url('/service')}}">Services</a>
                <a class="collapse-item" href="{{url('/service/create')}}">Create a Service</a>
            </div>
        </div>
    </li>
    <!-- Divider -->
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="{{url('/estimate')}}">
