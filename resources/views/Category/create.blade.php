                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control border-1" name="categoryDescreption"
                                    id="categoryDescreption" cols="30" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="parent_id">Category Parent</label>
                                <select class="form-control  border-1" name="parent_id" id="parent_id" required="">
                                    <option value="0" default="">No parent</option>
                                    @foreach (App\Category::all()->where('parent_id','=', '0') as $category)
